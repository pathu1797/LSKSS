            ...
            <div className="prose prose-lg max-w-none text-[var(--text-espresso)] leading-loose">
              ...
              <ScrollReveal>
                ...
                <p className="mb-6 text-lg italic text-[var(--primary-saffron)]">
                  त्यांना दोन मुले (पांडुरंग व हरिदास) व एक मुलगी आहे. पांडुरंग आणि हरिदास हे शास्त्रीय संगीत तसेच लोकसंगीताचे समर्पित साधक, कला उपासक आणि महाराष्ट्राच्या समृद्ध सांस्कृतिक परंपरेचे जतन व संवर्धन करणारे कलावंत आहेत. संगीत, लोककला आणि संस्कृतीचा वारसा जपण्यासाठी ते सातत्याने कार्यरत असून, आपल्या कलेद्वारे रसिकांपर्यंत लोकपरंपरेचे वैभव पोहोचवत आहेत आणि लोकसंस्कृती कला सेवा संघाचे संस्थापक आहेत.
                </p>
              </ScrollReveal>
            </div>
          </div>
